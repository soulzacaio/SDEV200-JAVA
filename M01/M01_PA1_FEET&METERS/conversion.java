...
public class conversion 
{
    ...
    public static void main(String[] args)
    {
        ...
        //initialize an int to be used as meter data, for foot data the iterator 'i' is used
        int meters = 20;

        //loop over 10 times
        for (int i=1;i<11;i++)
        {
            //this line prints a full row using String.format() to account for decimal places
            System.out.println(String.format("%.1f", (double)i) + "\t\t" + String.format("%.3f",footToMeter(i)) + "\t\t|\t" + String.format("%.1f", (double)meters) + "\t\t" + String.format("%.3f", meterToFoot(meters)));
